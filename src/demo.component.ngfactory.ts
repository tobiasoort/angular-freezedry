...
class View_DemoComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'lst-demo-component',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
...
export const DemoComponentNgFactory:import7.ComponentFactory<import0.DemoComponent> = new import7.ComponentFactory<import0.DemoComponent>('lst-demo-component',View_DemoComponent_Host0,import0.DemoComponent);
const styles_DemoComponent:any[] = ['h1[_ngcontent-%COMP%] {\n            padding: 10px;\n            border: solid 4px black;\n        }'];
var renderType_DemoComponent:import2.RenderComponentType = import3.createRenderComponentType('',0,import4.ViewEncapsulation.Emulated,styles_DemoComponent,{});
export class View_DemoComponent0 extends import1.AppView<import0.DemoComponent> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_2 = this.renderer.createText(this._el_1,'Demo Component',(null as any));
